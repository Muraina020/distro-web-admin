...
const Profile = () => {
  return (
    <div className="pt-[5rem] px-[2.5rem]">
      <div className="w-[6.25rem] h-[6.25rem] mx-auto">
        <img src={logo} alt="logo" className="w-full h-full object-cover" />
      </div>

      <form className="mt-12 flex items-center justify-center gap-x-[3rem]">
        <div className=" border-b w-full px-3 flex items-center">
          <label htmlFor="email" className="text-[1.125rem]">
            Emil Address
          </label>
          <input
            id="email"
            ...
            className="p-2 outline-none w-[72%]"
          />
        </div>

        <div className="border-b w-full flex items-center px-3">
          <label htmlFor="password" className="text-[1.125rem]">
            Password
          </label>
          <input
            id="password"
            type="password"
            placeholder="*************"
            className="p-2 outline-none basis-[65%]"
          />
          <button className="text-primary-default  text-[1.125rem]">
            Change
          </button>
        </div>
      </form>
      ...
      <div className="grid place-content-center">
        <button className="text-[1.75rem]  text-[#F00] mt-20 flex  items-center gap-x-2">
          <svg
